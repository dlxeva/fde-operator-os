...
- restate the loop, owner, and measurable outcome
...
- require action surface, state evidence, and operator ownership
...
- collect ugly cases, disputed cases, and handoff failures
...
- cut scope until one loop can be tested end-to-end
...
- start with advisory or gated action surfaces and add auditability
...
- name the operating owner before delivery architecture is finalized
