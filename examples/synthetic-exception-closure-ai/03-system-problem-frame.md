...
- **Non-goals**:
  ...
  - full automation of exception decisions
  - broad multi-category rollout in phase one
- **Critical assumptions**:
  - one exception category has enough recurring volume to pilot
  - coordinators can align on a minimum acceptable evidence standard
  - task creation can be triggered through existing tooling without major rebuild
- **Deferred questions**:
  - whether additional model support is needed for closure verification
  - how to unify reporting across all regional teams after phase one
